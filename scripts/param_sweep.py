...
def _run(
    ...
    cfg.trading.min_atr_ratio = min_atr_ratio
    cfg.trading.min_range_pips = min_range_pips
    cfg.trading.min_volume_ratio = min_volume_ratio
    all_trades = []
    for pair in _PAIRS:
        trades = _backtest_pair(pair, _bars[pair], cfg, min_sl_pips=min_sl_pips)
