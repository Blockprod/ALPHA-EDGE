...
# PYTHON       : 3.11.9
# STATUS       : Not connected to live pipeline — pending strategic decision.
#                Must validate OOS impact on Sharpe baseline (3.37) before
#                any integration into signal_pipeline.py.
# ============================================================
